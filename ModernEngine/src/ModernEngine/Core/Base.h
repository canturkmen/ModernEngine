...
#define MN_BIND_EVENT_FN(fn) [this](auto&& ... args) -> decltype(auto) {return this->fn(std::forward<decltype(args)>(args)...); }

namespace ModernEngine {

	// Unique pointer specification and creation.
	template<typename T>
	...
	// Shared pointer specification and creation.
	template<typename T>
